...
<ul class="sidebar navbar-nav">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" target="_blank" href="${pageContext.servletContext.contextPath}/vistasReportes/proyectosGastos.jsp">Gasto de todos <br> los proyectos</a>
            <a class="dropdown-item" target="_blank" href="${pageContext.servletContext.contextPath}/vistasReportes/proyectosED.jsp">Proyectos por estado y <br>departamento</a>
            <a class="dropdown-item" target="_blank" href="${pageContext.servletContext.contextPath}/vistasReportes/empleadosReporte.jsp">Emisi&oacute;n de boleta <br> de pagos</a>
            <a class="dropdown-item" target="_blank" href="${pageContext.servletContext.contextPath}/vistasReportes/proyectoERF.jsp">Proyectos que est&eacute;n en <br> ejecuci&oacute;n entre <br> un rango de fechas</a>
            <a class="dropdown-item" target="_blank" href="${pageContext.servletContext.contextPath}/vistasReportes/proyectoEntregados.jsp">Proyectos entregados <br> entre fechas</a>
            <a class="dropdown-item" target="_blank" href="${pageContext.servletContext.contextPath}/vistasReportes/proyectosGEF.jsp">Ganancia de proyectos <br> entre 2 fechas</a>
