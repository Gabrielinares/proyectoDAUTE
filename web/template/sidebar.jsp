...
<ul class="sidebar navbar-nav">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="${pageContext.servletContext.contextPath}/vistas/detalleempleado.jsp">Empleados asignados</a>
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="${pageContext.servletContext.contextPath}/vistasReportes/empleadosReporte.jsp">Emisi&oacute;n de boleta <br> de pagos</a>
            <a class="dropdown-item" href="${pageContext.servletContext.contextPath}/vistasReportes/proyectoERF.jsp">Proyectos que est&eacute;n en <br> ejecuci&oacute;n entre <br> un rango de fechas</a>
            <a class="dropdown-item" href="${pageContext.servletContext.contextPath}/vistasReportes/proyectoEntregados.jsp">Proyectos entregados <br> entre fechas</a>
